Shader "Custom/Terrain" {
    Properties { // информация, вводимая извне
        _GrassColour ("Grass Colour", Color) = (0,1,0,1)
		_SandColour("Sand Colour", Color) = (1,0,1,0)
    ...
    SubShader
    {
        ...
        CGPROGRAM
        #pragma surface surf Standard fullforwardshadows // стандартный алгоритм освещения (с тенями)
        #pragma target 3.0
